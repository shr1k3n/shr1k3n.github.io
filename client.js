...
let monthlyDataArray = [
    ...
    monthlyArr,
    ['Regular Monthly Expenses', 'Regular Weekly Expenses', 'Subscription Expenses', 'Loans'],
    overallExpenses,
    ['Total Leftover:'],
    totalLeftover
]
...
function calculateMonthly(){
    ...
    overallExpenses.push(monthlyTotal, weeklyTotal, subscriptionTotal, loansTotal)
